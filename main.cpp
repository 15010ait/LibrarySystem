...
int main() {
    // Example for EBook
    EBook myEbook;
    myEbook.setEBookDetails("Digital Learning", "Jane Doe", "123E", true, "2023-01-01", "PDF", 5.2);
    ...
    myPrintedBook.setPrintedBookDetails("C++ Mastery", "John Smith", "456P", true, "2022-10-10", 300, "Shelf A3");
